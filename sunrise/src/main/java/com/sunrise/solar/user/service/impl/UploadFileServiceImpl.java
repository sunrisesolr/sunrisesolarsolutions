...
public class UploadFileServiceImpl implements UploadFileService {
    ...
    public void uploadFile(String name, MultipartFile file) throws IOException, InvalidFormatException {
        ...
        {
            log.error("Exception occurred while processing the file",ioexception);
            throw ioexception;
        }
        catch (InvalidFormatException ioexception) {
            log.error("Exception occurred invalid format while processing the file", ioexception);
            throw ioexception;
        }
        catch (Exception e)
        {
            log.error("Exception occurred while processing the file",e);
            throw e;
        }
